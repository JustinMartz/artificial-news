    ...
    private List<ArticleEntity> buildTestArticles(List<ArticlePhotoEntity> testPhotos) {
        ...
        articleEntity2.setArticleBody(
                "In the heart of the vibrant city of Orlando, a unique phenomenon has been drawing"
                    ...
                    + " her eerie experience. \"It was a quiet afternoon, and my kids were playing"
                    + " nearby when I noticed the swings just started moving by themselves. I"
                    + " thought someone had given them a push, but no one was around,\" she said,"
                    + " her voice tinged with both excitement and unease. This playground has since"
                    + " become a hotspot for ghost hunters and tourists hoping to witness the"
                    + " swings in action.\n"
                    + "\n"
