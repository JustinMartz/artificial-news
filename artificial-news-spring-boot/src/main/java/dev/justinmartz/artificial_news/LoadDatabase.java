    ...
    private List<Article> buildTestArticles() {
        ...
        article1.setArticleBody(
                "In a delightful twist on the traditional marathon, the streets of Seattle played"
                    ...
                    + " awareness for wildlife conservation efforts. \\\"It's not just about"
                    + " running; it's about making a statement and bringing joy,\\\" said event"
                    ...
                    + " beginning of a new tradition in Seattle,\\\" she exclaimed, her eyes"
                    + " gleaming with hope.");
        ...
        article2.setArticleBody(
                "This October, Denver will play host to a spine-tingling affair that promises to be"
                    ...
                    + " and whimsical that would appeal to all ages,\\\" said Marissa Caldwell,"
                    + " event coordinator and founder of the Denver Sweet Society. \\\"Our cupcakes"
                    + " will be dressed up in their Halloween best, from ghoulish ghosts to"
                    + " decadent dark chocolate bats.\\\" Visitors can expect an impressive variety"
                    + " of flavors, including caramel apple cobweb, black velvet, and even pumpkin"
                    + " spice specter.\\n"
                    + "\\n"
                    ...
                    + " good cause. \\\"It's incredible to see how food can bring people together"
                    + " for such a meaningful purpose,\\\" Caldwell added. As the festival date"
        ...
        article3.setArticleBody(
                "In the heart of Savannah, Georgia, where history intertwines with mysticism, an"
                    ...
                    + " occasionally change ever so subtly under moonlight. \\\"These quilts are"
                    + " more than just fabric and thread,\\\" Jenkins explained to attendees, her"
                    + " voice echoing through the halls once walked by figures of the 19th century."
                    + " \\\"They tell the stories of the past, whispers sewn into each stitch.\\\""
                    + " The auction attracted collectors nationwide who sought to own not just a"
                    + " piece of art, but a fragment of an otherworldly narrative that ties them to"
                    + " the city's vibrant and often mysterious history.\\n"
                    + "\\n"
                    ...
                    + " Savannah’s unique blend of history and mystery. \\\"This auction"
                    + " demonstrates the enduring allure of Savannah's past,\\\" Michaels noted."
                    + " \\\"It's a city that never forgets its ghosts and celebrates the stories"
                    + " they have left behind.\\\" With all proceeds going to the preservation of"
                    + " local historical sites, the Ghostly Quilt Auction not only captivated"
                    + " imaginations but also contributed to the safeguarding of Savannah's"
                    + " heritage.");
