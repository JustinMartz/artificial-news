...
- [UI] Pagination information was displaying incorrectly after first page

- [service] Using environment variables for database auth now
...
[0.4.1]: https://github.com/JustinMartz/articifial-news/releases/tag/v0.4.1
