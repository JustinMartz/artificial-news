      ...
      {mutation.isPending ? (
        ...
        <main className="bg-white flex flex-grow md:flex-grow-0 lg:h-[75dvh] w-11/12 md:w-4/5 rounded-md shadow-md">
          <article className="flex justify-between p-2 lg:p-4">
            ...
            <section className="flex flex-col justify-between items-center h-auto p-2 lg:ml-4 lg:py-10 lg:pr-10 lg:w-2/3">
              ...
              <GenerateArticleButton clickHandler={handleClick} />
            </section>
          </article>
        </main>
      )}
