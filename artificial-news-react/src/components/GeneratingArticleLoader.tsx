...
export default function GeneratingArticleLoader() {
  const loadingMessages: Array<string> = [
    ...
    'Looking for the bacon stretcher...',
    'Checking the rope for knots...',
    'Holding out for better interest rates...',
    'Dividing by zero...',
    'Smelling what The Rock is cooking...',
    'Trying to exit vim...',
    'Watching paint dry...',
    'Shifting into second gear...',
    'Spending my time on Earth on a computer...',
  ];
  ...
  useEffect(() => {
    ...
    function iterate() {
      ...
      const interval = Math.floor(Math.random() * (3000 - 500 + 1)) + 500;
